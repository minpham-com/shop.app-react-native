  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Min Store. Built with Docusaurus.`,
      },
      prism: {
      ...
      metadata: [
        {
          name:'title',
          content: 'Min Store Starter | A template for your next React Native project 🚀',
        },
        {
          name: "description",
